...
public class Utente {
	...
	public Utente(String username, String password, String nome, String cognome, Date dateCreatedUser) {
		this.username = username;
		this.password = password;
		this.nome = nome;
	...
	public boolean isAdmin() {
		for (Ruolo ruoloItem : ruoli) {
			if (ruoloItem.getCodice().equals(Ruolo.ROLE_ADMIN_USER))
				return true;
		}
		return false;
	}

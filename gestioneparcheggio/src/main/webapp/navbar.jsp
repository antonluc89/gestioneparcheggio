			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="dropdown01">
					<a class="dropdown-item"
						...
						class="dropdown-item"
						href="${pageContext.request.contextPath}/PrepareSearchParcheggioServlet">Ricerca
						parcheggi</a> <a class="dropdown-item"
						href="${pageContext.request.contextPath}/PrepareSearchAutomobileServlet">Ricerca
						automobili</a>
				</div></li>
		</ul>
